...
export function FriendsList() {
  return (
    <div className="border-2 border-green-800 p-4 bg-green-950/20 my-6 font-vt323">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        {FRIENDS.map((friend) => (
          <a
            ...
            className="flex items-center justify-between p-2 hover:bg-green-900/20 hover:border-green-00 transition-all group"
          >
