  ...
  return (
    <div className="border-2 border-green-700 p-4 bg-green-950/30 my-6 font-vt323 shadow-[0_0_10px_rgba(0,255,0,0.1)]">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div>
          <span className="text-green-600 block text-sm">PHONETIC</span>
          <span className="text-lg">Bravo Indian Three Bravo Foxtrot Golf</span>
        </div>
